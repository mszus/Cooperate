...
@property (strong, nonatomic) IBOutlet UITextField *fieldID;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
    NSString *letter = [NSString stringWithFormat:@"%c", arc4random_uniform(99999999) + 'a'];
